...
function _fd_seek(fd, offset, whence, newOffset) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(36, 0, 1, fd, offset, whence, newOffset);
...
function golf_multiplayer_local_shot(level, stroke, px, py, pz, vx, vy, vz) {
  var message = {
    type: "openGolfLocalShot",
    level,
    stroke,
    position: {
      x: px,
  ...
  if (typeof window !== "undefined" && typeof window.openGolfLocalShot === "function") {
    window.openGolfLocalShot(message);
  }
...
function golf_multiplayer_hole_finished(level, strokes) {
  var message = {
    type: "openGolfHoleFinished",
    level,
    strokes
  };
  if (typeof window !== "undefined" && typeof window.openGolfHoleFinished === "function") {
    window.openGolfHoleFinished(message);
  }
  if (typeof window !== "undefined" && window.parent) {
    window.parent.postMessage(message, "*");
  }
      ...
      if (ptr) {
        ...
        for (var chn = 0; chn < num_channels; chn++) {
          ...
          for (var i = 0; i < num_frames; i++) {
            chan[i] = (growMemViews(), HEAPF32)[(ptr >> 2) + ((num_channels * i) + chn)];
          }
        }
      }
    };
...
var _golf_multiplayer_apply_remote_shot = Module["_golf_multiplayer_apply_remote_shot"] = makeInvalidEarlyAccess("_golf_multiplayer_apply_remote_shot");
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports["golf_multiplayer_apply_remote_shot"] != "undefined", "missing Wasm export: golf_multiplayer_apply_remote_shot");
  ...
  _golf_multiplayer_apply_remote_shot = Module["_golf_multiplayer_apply_remote_shot"] = createExportWrapper("golf_multiplayer_apply_remote_shot", 7);
  ...
  __sapp_emsc_end_drop = Module["__sapp_emsc_end_drop"] = createExportWrapper("_sapp_emsc_end_drop", 2);
...
function assignWasmImports() {
  wasmImports = {
    ...
    /** @export */ golf_multiplayer_hole_finished,
    /** @export */ golf_multiplayer_local_shot,
    ...
    /** @export */ sapp_js_create_textfield,
    /** @export */ sapp_js_focus_textfield,
    /** @export */ sapp_js_pointer_init,
    ...
    /** @export */ sapp_js_unfocus_textfield,
